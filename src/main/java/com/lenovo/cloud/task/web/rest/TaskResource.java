...
import com.lenovo.cloud.task.service.TaskService;
...
/**
 * REST controller for managing {@link com.lenovo.cloud.task.domain.Task}.
 */
@RestController
@RequestMapping("/api")
public class TaskResource {
    ...
    public ResponseEntity<Task> partialUpdateTask(@NotNull @RequestBody Task task) throws URISyntaxException {
        log.debug("REST request to update Task partially : {}", task);
        if (task.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
