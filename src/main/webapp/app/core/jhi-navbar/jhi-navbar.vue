<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="jh-navbar">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span v-text="$t('global.title')" class="navbar-title">TaskService</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/task-step">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.taskStep')">Task Step</span>
          </b-dropdown-item>
          <b-dropdown-item to="/task-execute-record">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.taskExecuteRecord')">Task Execute Record</span>
          </b-dropdown-item>
          <b-dropdown-item to="/task-step-execute-record">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.taskStepExecuteRecord')">Task Step Execute Record</span>
          </b-dropdown-item>
