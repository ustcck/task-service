...
export default class TaskStepExecuteRecord extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllTaskStepExecuteRecords();
  }
  ...
  public retrieveAllTaskStepExecuteRecords(): void {
  ...
  public prepareRemove(instance: ITaskStepExecuteRecord): void {
  ...
  public removeTaskStepExecuteRecord(): void {
    this.taskStepExecuteRecordService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('taskServiceApp.taskStepExecuteRecord.deleted', { param: this.removeId });
